<h1 align="center">Hi 👋, I'm Muntasir Mohamed Tariq</h1>
...
- 🔧 UI/UX Design with **Figma**, **Adobe XD**, **Bootstrap**, **Next.js**
- 💻 Frontend & Backend: **React**, **HTML**, **CSS**, **.NET**, **Telerik**
- 🧪 QA Automation: **Selenium**, **Playwright**
- 🎨 Visual Design: **Photoshop**, **Illustrator**
- 📸 Social Media Content: **Carousels**, **Reels**, **Stories**, **Interactive Posts**
- 🧠 Strategic Page Management & Audience Engagement
- 🧪 Technical Troubleshooting: **Vite**, **Node.js**

---

### 🚀 Current Goals

- 📈 Boost visibility for Island Aesthetic through tailored campaigns
- 🧑‍💻 Polish and showcase technical projects with bilingual captions
- 🥗 Maintain a weight-loss–friendly meal routine
- 💼 Apply for freelance/part-time design roles
...
![Telerik](https://img.shields.io/badge/Telerik-0C7ABF?style=for-the-badge&logoColor=white)
...
I turn everyday routines — like healthy eating — into engaging, content that educates and inspires.
